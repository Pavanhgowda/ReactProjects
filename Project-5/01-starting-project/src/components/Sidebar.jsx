...
function Sidebar({onStartAddProject,allprojects,onSelectProject,selectedProjectId}) {
  return (
    <aside className='w-1/3 px-8 py-20 bg-stone-900 text-stone-50 md:w-72 rounded-r-xl'>
